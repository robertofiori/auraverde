    ...
    <>
      <header className="relative flex items-center justify-between px-4 md:px-6 py-4 bg-background-light/95 dark:bg-background-dark/95 backdrop-blur-md sticky top-0 z-[100] shrink-0 gap-2 md:gap-4 h-20 md:h-24 transition-all">
        ...
        <Link 
          ...
          title="Ir al Inicio"
        >
          <h1 className="text-xl md:text-4xl font-sans font-black tracking-wider text-primary dark:text-primary transition-all duration-300 drop-shadow-[0_0_15px_rgba(19,236,55,0.3)] hover:scale-105 active:scale-95 uppercase whitespace-nowrap">
            Aura Verde
          </h1>
        </Link>
