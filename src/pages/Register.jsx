    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[70vh] px-4">
            <div className="w-full max-w-md bg-white dark:bg-surface-dark rounded-2xl shadow-xl p-8 border border-slate-100 dark:border-slate-800">
                <h2 className="text-3xl font-varela text-primary mb-2 text-center">Crear Cuenta</h2>
                <p className="text-slate-500 dark:text-slate-400 text-center mb-8">Únete a Aura Verde hoy</p>
