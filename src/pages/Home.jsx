        ...
        <div className="flex flex-col min-h-screen">
            ...
            <section className="relative h-[500px] w-full bg-surface-light dark:bg-surface-dark overflow-hidden flex items-center justify-center text-center px-4">
                ...
                <div className="relative z-10 max-w-3xl flex flex-col items-center gap-6 animate-fade-in-up">
                    <div className="inline-block px-4 py-1.5 rounded-full bg-primary/10 border border-primary/20 text-primary font-bold text-sm uppercase tracking-wider mb-2">
                    ...
                    <p className="text-lg md:text-xl text-slate-600 dark:text-slate-300 max-w-xl leading-relaxed">
                        Transforma tu espacio con nuestra colección curada de plantas de interior premium. Entregadas frescas desde nuestro vivero hasta tu puerta.
                    </p>
            ...
            <section className="py-16 px-6 bg-white dark:bg-surface-dark/50">
                <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
                    {[
                        { icon: "local_shipping", title: "Envío Gratis", text: "En órdenes sobre $75" },
                        { icon: "verified", title: "Garantía de Calidad", text: "Plantas sanas o dinero devuelto" },
                        { icon: "support_agent", title: "Soporte Experto", text: "Consejos de cuidado 24/7" }
                    ].map((item, index) => (
                        <div key={index} className="flex flex-col items-center text-center p-6 rounded-3xl bg-background-light dark:bg-background-dark border border-gray-100 dark:border-white/5 shadow-sm hover:shadow-md transition-shadow">
